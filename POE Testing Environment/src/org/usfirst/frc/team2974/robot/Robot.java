...
public class Robot extends IterativeRobot {
     ...
     *  getSubsystem(DriveTrain.class) -> DriveTrain on Robot
     *
	...
	public static <T extends Subsystem> T getSubsystem(Class<T> type) {
        T subsystem = _instance.subsystems.stream()
        ...
        if(subsystem == null) // FIXME? should this be like this, or throw Exception
            System.err.println("Subsystem of type " + type.getTypeName() + " does not exist. \nDid you forget to add it?");
