...
public class MotionPathSpline extends MotionProvider {
	 ...
	 * @param l0 offset length from initial pose, used to create control points. i.e. creates how
	 * curvy you want the spline
	 * @param final_ final pose
	 * @param l1 offset length from final pose, used to create control points. i.e. creates how
	 * curvy you want the spline
