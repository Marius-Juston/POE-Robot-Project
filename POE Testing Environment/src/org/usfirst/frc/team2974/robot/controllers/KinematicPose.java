...
public class KinematicPose extends Pose {
    ...
    public KinematicPose(Pose pose, KinematicState left, KinematicState right, double t,
        boolean isFinished) {
    ...
    public String toString() {
        return String
            .format("%s.Kinematic{left:%s, right:%s, t=%f, isFinished=%s}", super.toString(), left,
                right, t, isFinished);
    }
